export default {
  ...
  state: {
    pages: {
      login: {
        title: 'Привет!',
        text: 'Мы создали это место, чтобы вы смогли развиваться, чувствуя себя максимально комфортно в кругу приятных людей. Это сообщество профессионалов, объединённых одной идеей — с помощью кода магия станет реальностью!',
        btn: {
          link: 'Registration',
          text: 'Регистрация'
        }
      ...
      'registration-success': {
        ...
        text: 'Ваш аккаунт успешно создан. Чтобы активировать его, вам необходимо войти в систему, используя данные, указанные при регистрации.',
        btn: {
          link: 'Login',
          text: 'Войти'
        }
      ...
      forgot: {
        ...
        text: 'Чтобы восстановить пароль, укажите e-mail, к которому привязана ваша страница. Мы отправим ссылку для восстановления пароля туда.',
        btn: {
          link: 'Login',
      ...
      'account/send_recovery_massage': {
        title: 'Восстановление пароля',
        text: 'Ваш старый пароль был сброшен. Придумайте новый пароль для входа на сайт.'
      },
      'shift-password-success': {
